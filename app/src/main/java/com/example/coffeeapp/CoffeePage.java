...
public class CoffeePage extends AppCompatActivity {
    ...
    Button Add,minus,confrim,new_order;
    TextView cups,total;
        ...
        Add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                } else
                {
                    ...
                    Toast.makeText(CoffeePage.this,"You Can't Order More Than 10 Cups at Once",Toast.LENGTH_LONG).show();
                }
            }
        });
        ...
        minus.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                } else
                {
                    ...
                    Toast.makeText(CoffeePage.this,"You Can't Order Less Than 0 Cups",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
